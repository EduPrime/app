...
const fields = ['course_modality', 'course_stage', 'created_at', 'deleted_at', 'description', 'id', 'institution_id', 'metadata', 'name', 'regime_type', 'school_id', 'status', 'teaching_type', 'updated_at', 'user_created', 'workload']
