...
const service = new School_courseService()

// Define o tipo dinamicamente com base em tableName
const dataList = ref<Tables<'school_course'>[]>([])

// Nome da tabela e campos
const tableName = 'school_course'
const fields = ['course_id', 'created_at', 'id', 'school_id']
