...
const fields = ['course_id', 'course_stage', 'created_at', 'deleted_at', 'graduate', 'id', 'institution_id', 'metadata', 'name', 'school_days', 'school_id', 'timetable_id', 'updated_at', 'user_created', 'workload']
