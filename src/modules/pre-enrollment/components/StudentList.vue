...
const fields = ['address', 'birth_certificate', 'birthdate', 'city', 'complement', 'cpf', 'created_at', 'deficiency', 'deficiency_description', 'deleted_at', 'docsType', 'email', 'ethnicity', 'father_cpf', 'father_email', 'father_name', 'father_phone', 'gender', 'id', 'metadata', 'mother_cpf', 'mother_email', 'mother_name', 'mother_phone', 'name', 'neighborhood', 'number_address', 'phone', 'photo', 'place_of_birth', 'postalcode', 'residence_zone', 'responsibleType', 'rg_issue_date', 'rg_issuer', 'rg_number', 'rg_state', 'status', 'updated_at', 'user_created']
