...
const fields = ['abbreviation', 'active', 'address', 'city', 'created_at', 'deleted_at', 'email', 'id', 'institution_id', 'logourl', 'name', 'phone', 'postalcode', 'school_zone', 'social_network', 'state', 'updated_at', 'user_created', 'website']
