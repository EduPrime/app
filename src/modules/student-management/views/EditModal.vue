...
import type ModalForm from '../../student-management/components/ModalForm.vue'
import { ref } from 'vue'
...
<template>
  <content-layout :show-footer="true">
    ...
    <div id="modal-form">
      <ModalForm ref="modalFormRef" @cancel="handleCancel" @save="handleSave" />
    </div>
