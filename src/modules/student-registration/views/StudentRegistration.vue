...
function navigateToRegister() {
  router.push({ name: 'RegisterStudentRegistration' })
}
...
<template>
  <ContentLayout>
    <IonToolbar>
      <IonTitle>Student Registration ({{ filteredData.length }})</IonTitle>
    </IonToolbar>
    ...
    <StudentRegistration :items="filteredData" @update:items="loadData" />
  </ContentLayout>
</template>
